...
- Token counts based on actual measurements from this repository
"""
    return table
...
def generate_cost_analysis() -> str:
    """Generate complete cost analysis markdown."""
    timestamp = datetime.utcnow().strftime("%Y-%m-%d %H:%M:%S UTC")
    
    markdown = f"""# Security Scanning Cost Analysis
...
def main():
    ...
    markdown = generate_cost_analysis()
